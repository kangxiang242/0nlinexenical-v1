...
<body class=" {{ request()->is('/')?"page-index -loading":"" }} ">
    ...
    <header class="main-header">
        <div class="wrapper">
            ...
            <button class="show-menu"><i class="iconfont">&#xe62c;</i></button>
        </div>
    </header>

    @section('menu')
        <nav class="main-menu">
            <button class="close-menu"><i class="iconfont">&#xeca0;</i></button>
            <div class="menu">
            ...
            <nav class="footer-menu">
                ...
                <section class="menu">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="{{ URL::to('check') }}">羅氏鮮減肥藥訂單追蹤，控制BMI不用等<i class="iconfont">&#xe775;</i></a></li>
                        <li><a href="{{ URL::to('message') }}">取得羅氏鮮減肥藥官網協助，線上解答BMI控制常見問題<i class="iconfont">&#xe775;</i></a></li>
                        <li><a href="{{ URL::to('privacy') }}">{{ app('cache.config')->get('page_privacy_title_gb') }}<i class="iconfont">&#xe775;</i></a></li>
                    </ul>
                </section>
