...
@section('content')
    ...
    <h1 class="main-title page-title">{!! app('cache.config')->get('page_message_title_gb') !!}</h1>
    <div class="main">
        <section class="quick">
            ...
            @foreach($faqs as $item)
                <details class="faq-item" open>
                    <summary class="faq-question">
                        <span class="question-text">Q：{{ $item->questions_gb }}</span>
                        <i class="iconfont faq-icon">&#xeca2;</i>
                    </summary>
                    <p class="faq-answer">A：{{ $item->answers_gb }}</p>
                </details>
            @endforeach
        </section>
