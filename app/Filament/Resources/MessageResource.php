            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('related_orders')
                    ...
                    ->getStateUsing(function ($record) {
                        ...
                        $relatedOrders = $record->related_orders;
                ...
                Tables\Columns\TextColumn::make('ip')
                    ...
                    ->formatStateUsing(function ($record) {
                        ...
                        if ($record->user_agent) {
                            $device = \App\Handlers\DeviceTypeHandlers::getDevice($record->user_agent);
                            $browser = \App\Handlers\DeviceTypeHandlers::getBrowser($record->user_agent);
